...
class Odometrium:
    def __init__(self, left=None, right=None, wheel_diameter=5.6, wheel_distance=12, count_per_rot_left=None, count_per_rot_right=None, debug=False, curve_adjustment=0.873):
        ...
        # init motor wheel
        self.__motor_left = LargeMotor(OUTPUT_A)
        self.__motor_right = LargeMotor(OUTPUT_B)
